module.exports = {
  ...
  pcMain: {
    ...
    modalLogin: {
      ...
      signupPolicyDesc1: {
        en: '패션잡화 관련 소매업자에 한해 가입승인이 진행되며,',
        ko: '패션잡화 관련 소매업자에 한해 가입승인이 진행되며,',
        'zh-cn': '패션잡화 관련 소매업자에 한해 가입승인이 진행되며,',
        'zh-tw': '패션잡화 관련 소매업자에 한해 가입승인이 진행되며,',
      },
      signupPolicyDesc2: {
        en: '취급품목 및 업태가 다른 경우 승인이 반려될 수 있습니다.',
        ko: '취급품목 및 업태가 다른 경우 승인이 반려될 수 있습니다.',
  ...
  pcPayment: {
    ...
    refundPolicyDesc1: {
      en: '품절 및 재고상황에 따라 일부 상품이',
      ko: '품절 및 재고상황에 따라 일부 상품이',
      'zh-cn': '품절 및 재고상황에 따라 일부 상품이',
      'zh-tw': '품절 및 재고상황에 따라 일부 상품이',
    },
    refundPolicyDesc2: {
      en: '배송 되지 않을 수 있으며 미 배송 상품의',
      ko: '배송 되지 않을 수 있으며 미 배송 상품의',
      'zh-cn': '배송 되지 않을 수 있으며 미 배송 상품의',
      'zh-tw': '배송 되지 않을 수 있으며 미 배송 상품의',
    },
    refundPolicyDesc3: {
      en: '환급 절차는 이용약관 제14조에 따릅니다',
      ko: '환급 절차는 이용약관 제14조에 따릅니다',
      'zh-cn': '환급 절차는 이용약관 제14조에 따릅니다',
      'zh-tw': '환급 절차는 이용약관 제14조에 따릅니다',
    },
    refundPolicyMore1: {
      en: '도매시장의 특성 상 판매자의 실시간 재고 파악이 불가능 합니다.',
      ko: '도매시장의 특성 상 판매자의 실시간 재고 파악이 불가능 합니다.',
      'zh-cn': '도매시장의 특성 상 판매자의 실시간 재고 파악이 불가능 합니다.',
      'zh-tw': '도매시장의 특성 상 판매자의 실시간 재고 파악이 불가능 합니다.',
    },
    refundPolicyMore2: {
      en: '판매자 또는 제조사의 사정으로 상품이 품절되거나 재고가 부족할 수 있습니다.',
      ko: '판매자 또는 제조사의 사정으로 상품이 품절되거나 재고가 부족할 수 있습니다.',
      'zh-cn': '판매자 또는 제조사의 사정으로 상품이 품절되거나 재고가 부족할 수 있습니다.',
      'zh-tw': '판매자 또는 제조사의 사정으로 상품이 품절되거나 재고가 부족할 수 있습니다.',
    },
    refundPolicyMore3: {
      en: '품절된 상품의 경우 해당 상품금액에 사입비 / 부가세 (국내에 한함)를 포함하여 주문 당시 동일 결제수단으로 자동 환불 처리해 드립니다.',
      ko: '품절된 상품의 경우 해당 상품금액에 사입비 / 부가세 (국내에 한함)를 포함하여 주문 당시 동일 결제수단으로 자동 환불 처리해 드립니다.',
      'zh-cn': '품절된 상품의 경우 해당 상품금액에 사입비 / 부가세 (국내에 한함)를 포함하여 주문 당시 동일 결제수단으로 자동 환불 처리해 드립니다.',
      'zh-tw': '품절된 상품의 경우 해당 상품금액에 사입비 / 부가세 (국내에 한함)를 포함하여 주문 당시 동일 결제수단으로 자동 환불 처리해 드립니다.',
    },
  },
  pcProductList: {
    sortLowPrice: {
